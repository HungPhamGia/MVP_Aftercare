...
def _system_prompt(questions: list[str], patient: dict) -> str:
    ...
    return (
        ...
        "hậu phẫu. Xưng 'cháu' hoặc 'em', gọi bệnh nhân bằng xưng hô phù hợp tuổi/giới tính"
        ...
        "tính là câu trả lời — lịch sự xin nhắc lại (ví dụ: 'Dạ cháu xin lỗi, cháu chưa nghe rõ, "
        "mình có thể nhắc lại được không ạ?', đổi cách nói cho tự nhiên) rồi hỏi lại đúng câu đó.\n"
